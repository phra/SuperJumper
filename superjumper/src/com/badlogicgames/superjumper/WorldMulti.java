...
public class WorldMulti {
    ...
    protected static LinkedBlockingQueue<Pacco> QueueOut, QueueIn;

    protected static void putPaccoIn(Pacco pkt) throws InterruptedException{
   		QueueIn.put(pkt);
    }
    
    protected static void putPaccoOut(Pacco pkt) throws InterruptedException{
   		QueueOut.put(pkt);
    }
    
    protected static Pacco takePaccoIn() throws InterruptedException{
   	 	return QueueIn.take();
    }
    
    protected static Pacco takePaccoOut() throws InterruptedException{
